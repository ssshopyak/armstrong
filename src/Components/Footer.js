        ...
        <div className='footer'>
            <div className='footerContainers'>
                ...
                <div className='shopInfo'>
                    ...
                    <div style={{color:'#fff',display:'flex',flexDirection:'column', marginLeft:'10px'}}>
                        ...
                        <span><a className='phoneTag' style={{color:'#fff'}} href="tel:+1-516-721-1119">516-721-1119 Roman</a></span>
                        <span><a className='phoneTag' style={{color:'#fff'}} href="tel:+1-630-796-8289">630-796-8289 Andry</a></span>  
                    </div>
                </div>
                <div className='shopInfo'>
                    <div>
            ...
            <div className='footerContainers'>
                <div style={{display:'flex', flexDirection:'column'}}>
                    ...
                    <Link to="/"  style={{color:'#fff',marginTop:'5px', marginBottom:'5px'}}> About us</Link>
                    <Link to="/regulation"  style={{color:'#fff',marginTop:'5px', marginBottom:'5px'}}> Store Regulations</Link>
                </div>
            </div>
            <div className='footerContainers'>
